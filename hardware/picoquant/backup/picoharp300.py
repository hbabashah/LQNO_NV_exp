...
#4:nactual:c_long(198) byref shode:<cparam 'P' (0000023DF89D1390)>
    ...
    def configure(self, bin_width_ns, record_length_ns, number_of_gates = 0):
        ...
        self.ACQtime = 30*e-3  # 10 second is ok, ACQ time in seconds
        print('resolution')
        print(self._bin_width_ns*1e-9)
        self.period = 400e-9  # period/2 is the resolution
...
#        # time.sleep(0.2)
        ...
        if self.useNIcardDI==1:
            ...
            try:
                ...
                if self.numberofsweeps < 10000 and self.meas_run: #NI card number of Sweeps
