...
#4:nactual:c_long(198) byref shode:<cparam 'P' (0000023DF89D1390)>
    ...
    def get_data_testfile(self):
        ...
        print(data)
        print('heeeeeeeeeeeeeeeeelllllllllllllllllooooooooooo')
        time.sleep(0.5)
        return data
     ...
     #   self.sigAnalyzeData.emit(buffer[0:actual_counts-1], actual_counts)
        ...
        if not self.meas_run:
            with self.threadlock:
                print('measurement is finished:trying to unlock and stop the device')
                self.unlock()
                self.stop_device()
                return
...
######################################################################################################
    ...
    #    self.data_trace2 = np.zeros(actual_counts,dtype=np.int64)
        #print('begining of the for loop/actualCOunts')
       # print(actual_counts)
        if (actual_counts):
     ...
     #   print('timeTag0')
      #  print(self.timetag0)
       #
          ################### PROCESS self.data_trace2
      #  print('new data')
     #   print(self.data_trace2)
    #    print(np.histogram(self.data_trace2,self.mybins)[0])
       # print(np.shape(np.histogram(self.data_trace2,self.mybins)[0]))
    #    self.data_trace=self.data_trace+np.histogram(self.data_trace2,self.mybins)[0]
      #  print(self.data_trace)
      #  print(np.max(self.data_trace))        
        #self.data_trace=1+self.data_trace
