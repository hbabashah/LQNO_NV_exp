...
#4:nactual:c_long(198) byref shode:<cparam 'P' (0000023DF89D1390)>
    ...
    def get_fresh_data_loop(self):
       # print('get_fresh_data_loop')
        ...
        self.sigAnalyzeData.emit(buffer[0:actual_counts-1], actual_counts) # analyze
...
#                             Mydata[kkk] = self.MytimeTag - self.timetag0
...
#                # self.data_trace_helper20 = np.array([], dtype=np.int64)
#                 print('wiered')
#                 self.data_trace_helper = self.data_trace_helper + np.histogram(Mydata[0:self.Endmarker], self.mybins)[0]
#                 if self.finishtime:
#                     # print('finishtime')
